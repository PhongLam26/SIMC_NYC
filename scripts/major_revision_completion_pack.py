...
def completion_checklist() -> str:
    items = [
        ...
        ("PDF <=15 pages", "PASS", "paper_overleaf/main.pdf is 12 A4 pages."),
        ...
        ("SIMC submission compliance PASS", "PASS", "paper_springer/main_SIMC_submission.pdf rebuilt and audited: 12 A4 pages, no links/bookmarks/page numbers/headers/footers, fonts embedded, no Type 3 fonts, and required visible text retained."),

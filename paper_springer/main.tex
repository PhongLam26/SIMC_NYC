...
\noindent\textbf{Data and code availability.} Source data include NYC Open Data 311 archives \texttt{76ig-c548} and \texttt{erm2-nwe9}, 2020 NTA boundaries \texttt{9nt8-h7nd}, NOAA GHCN-Daily observations from Central Park station \texttt{GHCND:USW00094728} used as city-level weekly weather exposure, OpenStreetMap via Overpass, and NYC PLUTO/MapPLUTO \texttt{64uk-42ks}. OSM/PLUTO snapshots for retrospective context analysis were extracted on 25 June 2026. Scripts, mappings, configurations, and evaluation code are available at \texttt{https://github.com/PhongLam26/SIMC\_NYC}. The repository separates prospective model artifacts from retrospective OSM/PLUTO checks; processed-data release remains subject to licensing, redistribution, and storage constraints.\par

...
Figure \ref{fig:shap_group} summarizes SHAP importance for the prospective LightGBM component. Historical temporal features dominate, accounting for 75.15\% of summed mean absolute SHAP importance across 21 features. Service category accounts for 8.16\%, calendar for 6.13\%, weather for 5.87\%, current demand for 2.74\%, and spatial identifiers for 1.23\%. OSM and PLUTO do not appear because they are not final prospective inputs.

\begin{figure}[t]
\centering
\includegraphics[width=0.92\linewidth]{figures/shap_group_importance.png}
\caption{Normalized summed mean absolute SHAP importance for the prospective LightGBM explanation backbone. Historical temporal demand features dominate; OSM and PLUTO are absent from the final prospective explanation.}

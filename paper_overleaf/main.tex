...
Selected settings & LightGBM: binary objective, min\_child\_samples = 100, subsample = 0.85, colsample\_bytree = 0.85, reg\_lambda = 3.0. XGBoost: binary:logistic objective, eval\_metric = aucpr, min\_child\_weight = 80, subsample = 0.9, colsample\_bytree = 0.9, reg\_lambda = 5.0, tree\_method = hist. Seed 42 is used for sampling and model fitting \\
